...
describe('CoursesController e2e tests', () => {
  ...
  describe('POST /courses', () => {
    it('shoud create a course', async () => {
  ...
  describe('GET /courses', () => {
    it('shoud list all courses', async () => {
      const res = await request(app.getHttpServer())
        .get('/courses')
        .expect(200);
  ...
  describe('GET /courses/:id', () => {
    it('shoud gets one course', async () => {
      const res = await request(app.getHttpServer())
  ...
  describe('Put /courses/:id', () => {
    it('shoud update a course', async () => {
      const updateData = {
        name: 'New Name',
        description: 'Name description ajajhs',
        tags: ['one', 'two'],
      };
  ...
  describe('DELETE /courses/:id', () => {
    it('shoud delete one course', async () => {
      const res = await request(app.getHttpServer())
